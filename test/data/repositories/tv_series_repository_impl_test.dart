...
import 'package:tv_series_dicoding/common/exception.dart';
import 'package:tv_series_dicoding/common/failure.dart';
import 'package:tv_series_dicoding/data/models/tv_series_detail_model.dart';
import 'package:tv_series_dicoding/data/models/tv_series_model.dart';
import 'package:tv_series_dicoding/data/models/tv_series_table.dart';
import 'package:tv_series_dicoding/data/repositories/tv_series_repository_impl.dart';
...
void main() {
  ...
  group('Get TV Series Detail', () {
    final tId = 1;
    final tvResponse = TvSeriesDetailModel(
      id: 1,
      name: 'sanco',
      genres: [],
    ...
    test(
      ...
      expect(result, equals(Right(tvEntity)));
    });
